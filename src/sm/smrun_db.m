function data = smrun_db(scan, filename)
...
if nargin >= 2
    save(filename, 'configvals', 'configdata', 'scan', 'configch','smdata');
...
for i = 1:totpoints    
    ...
    if get(figurenumber, 'CurrentCharacter') == char(27)
        ...
        if nargin >= 2
            save(filename, 'configvals', 'configdata', 'scan', 'configch', 'data','smdata')
        end
        set(figurenumber, 'CurrentCharacter', char(0));
